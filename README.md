...
| Primary focus | UI primitives, shared components, front-end foundations |
...
- This repo currently publishes `@platform/ui` as the legacy compatibility package id while the migration to `@gutu/ui` is completed.
